            ...
            onPressed: () async {
              ...
              ref
                ...
                if (value.statusCode == 200) {
                  ...
                  // // print("data  ${decodedValue['email']}");

                  // // if(decodedValue['passwordAutoGenerated'] == true){
                  //   // print("true  ${decodedValue['passwordAutoGenerated']}");
                  // if(decodedValue['passwordAutoGenerated'] == true){
                  //   _showResetPassword(context,email,_passwordController.text);

                  // } else{
                  //   // print("false  ${decodedValue['passwordAutoGenerated']}");
                  // }
